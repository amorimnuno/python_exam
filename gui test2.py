...
class Filme:
    def __init__(self, nome, realizador, ano, classificacao, genero, sala, reservas):
        ...
        self.reservas_iniciais = reservas  # Novo atributo para armazenar o valor inicial das reservas

# Classe para representar o cinema e gerir os filmes
class Cinema:
    def __init__(self):
        self.filmes = []
    ...
    # Redefine as reservas de todos os filmes para o valor inicial
    def remover_reservas(self):
        for filme in self.filmes:
            filme.bilhetes_disponiveis = filme.reservas_iniciais

    # Reserva uma quantidade específica de bilhetes para um filme
    ...
    # Carrega a lista de filmes de um ficheiro CSV
    ...
    # Guarda a lista de filmes num ficheiro CSV
...
# Classe para representar a interface principal da aplicação
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.add_button.clicked.connect(self.adicionar_filme)
        ...
        # Formulário para reservar bilhetes
        ...
        self.reserve_button.clicked.connect(self.reservar_bilhete)
        ...
        self.remove_button.clicked.connect(self.remover_filme)
    ...
    # Atualiza a tabela com a lista de filmes
    ...
    # Função para remover todas as reservas
    def remover_reservas(self):
        self.cinema.remover_reservas()
        self.atualizar_tabela()

    # Função para carregar filmes a partir de um ficheiro CSV
    ...
    # Função para guardar filmes num ficheiro CSV
    def salvar_csv(self):
        csv_path, _ = QFileDialog.getSaveFileName(self, "Salvar CSV", "", "CSV Files (*.csv)")
        if csv_path:
            self.cinema.salvar_filmes(csv_path)

    # Função para mostrar um gráfico das reservas
    def mostrar_grafico(self):
        filmes = [filme.nome for filme in self.cinema.filmes]
        bilhetes_reservados = [filme.reservas_iniciais - filme.bilhetes_disponiveis for filme in self.cinema.filmes]
